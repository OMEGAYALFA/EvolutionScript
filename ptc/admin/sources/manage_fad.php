...
<div class=\"site_title\">مدیریت آگهی های ویژه</div>
...
echo "            </select>
                ...
                <tr>
                    <td align=\"right\">عنوان آگهی</td>
                    <td><input type=\"text\" name=\"title\" value=\"";
echo $input->r['title'];
echo "\" /></td>
                    <td align=\"right\">توضیحات</td>
                    <td><input type=\"text\" name=\"ad\" value=\"";
echo $input->r['ad'];
echo "\" /></td>
                </tr>
                <tr>
                    <td align=\"right\">آدرس اینترنتی آگهی</td>
                    <td colspan=\"3\"><input  style=\"direction:ltr !important;\"  type=\"text\" name=\"url\" value=\"";
echo $input->r['url'];
echo "\" /></td>
                </tr>
                <tr>
	...
	echo "    <div class=\"widget-title\" style=\"margin-top:5px\">اقدام</div>
        <div class=\"widget-content\">
        	<select name=\"a\">
                ...
                <option value=\"selfsponsored\">حمایت از جانب مدیر</option>
            </select>
