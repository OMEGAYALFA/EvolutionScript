...
<div class=\"site_title\">مدیریت تبلیغات کلیکی</div>
...
foreach ($adcategories as $k) {
	...
	if ($input->r['category'] == $k['id']) {
		echo "<option value=\"" . $k['id'] . "\" selected>" . $k['catname'] . " - " . $k['value'] . " تومان - " . $k['time'] . " ثانیه</option>";
		continue;
	}

	echo "<option value=\"" . $k['id'] . "\">" . $k['catname'] . " - " . $k['value'] . " تومان - " . $k['time'] . " ثانیه</option>";
}
...
echo " / ";
echo $paginator->linkorder("outside_clicks", "خروجی");
echo "</td>
        <td align=\"center\">";
echo $paginator->linkorder("click_pack", "اعتبار کم شده");
echo "</td>
        <td align=\"center\">";
echo $paginator->linkorder("clicks_today", "کلیک های امروز");
echo "</td>
        <td align=\"center\">";
echo $paginator->linkorder("value", "نوع");
echo "</td>
        <td align=\"center\">";
