<?php /* Smarty version Smarty-3.1.13, created on 2014-03-15 20:25:04
         compiled from "C:\WampDeveloper\Websites\collection.me\webroot\templates\ModernBlue\summary.tpl" */ ?>
<?php /*%%SmartyHeaderCode:259045324b7205cf521-89525346%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '991200716aa14f8bf4d9407eef7efadcc8a627ad' => 
    array (
      0 => 'C:\\WampDeveloper\\Websites\\collection.me\\webroot\\templates\\ModernBlue\\summary.tpl',
      1 => 1394168001,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '259045324b7205cf521-89525346',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5324b72073b5d0_82825262',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5324b72073b5d0_82825262')) {function content_5324b72073b5d0_82825262($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'C:\\WampDeveloper\\Websites\\collection.me\\webroot\\includes\\plugins\\smarty\\plugins\\modifier.date_format.php';
if (!is_callable('smarty_modifier_replace')) include 'C:\\WampDeveloper\\Websites\\collection.me\\webroot\\includes\\plugins\\smarty\\plugins\\modifier.replace.php';
...
<div id="tabs">
	<ul>
    	<li><a href="#tab-1">General Stats</a></li>
    	<li><a href="#tab-2">Advertiser Stats</a></li>
    	<li><a href="#tab-3">Charts</a></li>
    	<li><a href="#tab-4">Login Failures</a></li>
    </ul>
    <div id="tab-1">
...
' showLabels='0' numVDivLines='8' hoverCapBgColor='f7df39' decimalPrecision='4' formatNumberScale='0' showValues='0'  divLineAlpha='20' alternateHGridAlpha='6'><?php echo $_smarty_tpl->tpl_vars['autopayclicks']->value;?>
    ...
    <div id="tab-4">
        <div class="widget-title">Login Failures</div>
        <div class="widget-content">
...
:</strong> <?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['loginfailure']->value[$_smarty_tpl->getVariable('smarty')->value['section']['f']['index']]['date'],"%b %e %Y %r");?>
</div>
                </div>
            <?php endfor; endif; ?>
        <?php }else{ ?>
