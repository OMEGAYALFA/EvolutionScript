<?php /* Smarty version Smarty-3.1.13, created on 2014-04-21 16:09:38
         compiled from "C:\WampDeveloper\Websites\collection.me\webroot\templates\ModernBlue\helpdesk.tpl" */ ?>
<?php /*%%SmartyHeaderCode:126255324b7d96595f0-81297343%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '476d93f8994674aea282758c105a8746ecca9681' => 
    array (
      0 => 'C:\\WampDeveloper\\Websites\\collection.me\\webroot\\templates\\ModernBlue\\helpdesk.tpl',
      1 => 1398080376,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '126255324b7d96595f0-81297343',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_5324b7d97b40e1_89615501',
  'variables' => 
  array (
    'settings' => 0,
    'lang' => 0,
...
<?php if ($_valid && !is_callable('content_5324b7d97b40e1_89615501')) {function content_5324b7d97b40e1_89615501($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'C:\\WampDeveloper\\Websites\\collection.me\\webroot\\includes\\plugins\\smarty\\plugins\\modifier.date_format.php';
...
"> <input type="button" name="btn" value="Go back" onclick="history.back();" /></td>
    </tr>
</table>
</form>
...
" />
        ...
        <td valign="top">
        	...
        	<div class="view-ticket-box">
                <div style="padding-bottom:10px;">We provide archives and history of all your current and past support requests complete with responses.</div>
                <div>
                                <table>
                	<tr>
...
<div class="widget-content">
	<table width="100%" class="tbl-content">
    	<tr>
            ...
            <td>پشتیبانی های سایت 24 ساعته صورت میگیرد.</td>
        </tr>
        <tr>
...
"><?php echo $_smarty_tpl->tpl_vars['item']->value['ticket'];?>
                ...
                <td><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['item']->value['last_update'],"%b %e, %Y");?>
</td>
                <td align="center">
        ...
        <tr>
            <td colspan="10" align="center">تیکت پشتیبانی از جانب شما در سرور ثبت نشده است</td>
        </tr>
        <?php }?>
