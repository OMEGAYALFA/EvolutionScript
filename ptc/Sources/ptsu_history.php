...
$allowed = array("date", "title", "value", "status");
$paginator = new Pagination("ptsu_requests", "user_id=" . $user_info['id']);
...
$paginator->setLink("./?view=account&page=ptsu_history&");
...
unset($items);
$smarty->assign("file_name", "ptsu_history.tpl");
