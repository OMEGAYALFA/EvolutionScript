...
echo "\" onsubmit=\"return submitform(this.id);\">
	<table width=\"100%\" class=\"widget-tbl\">
    	<tr>
        	<td align=\"right\" width=\"200\">مرچنت زرین گیت : </td>
...
echo $r['min_deposit'];
echo "\" /> (توجه : پرداخت مبلغ کمتر از 100 تومان از طریق زرین پال امکان پذیر نمی باشد)</td>
        </tr>
    	<tr>
        	<td align=\"right\">اجازه درخواست تسویه حساب از طریق زرین پال</td>
...
echo "</td>
 ...
 <tr>
            ...
            <td>";
echo "<a  style=\"color:#0000CC\" href=\"http://arshad98.ir/author/hannanstd/\" target=\"_blank\">حنان ابراهیمی ستوده</a>";
echo "</td>
        </tr>
